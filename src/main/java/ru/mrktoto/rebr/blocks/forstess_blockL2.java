...
public class forstess_blockL2 extends BlockTileEntity<TileEntityCounterPersonal> {

	public static final String[] metadata = new String[] {
			"forstess_blockL2",
	        "forstess_blockL2_meta_1", 
	        "forstess_blockL2_meta_2", 
	        "forstess_blockL2_meta_3", 
	        "forstess_blockL2_meta_4", 
	        "forstess_blockL2_meta_5",
	        "forstess_blockL2_meta_6",
	        "forstess_blockL2_meta_7",
	    };
    ...
    public IIcon getIcon(int side, int metadata) {
        if (metadata >= 0 && metadata < forstess_blockL2.metadata.length) {
	...
	public forstess_blockL2(String name, Material material, float hardness, float resistanse, SoundType soundType) {
		...
		this.setBlockTextureName(rebr.MODID + ":" + "forstess_block/forstess_blockL2");
	}
	...
	public float getPlayerRelativeBlockHardness(EntityPlayer player, World world, int x, int y, int z) {
		...
		if (!(player.inventory.getCurrentItem() == null) && (!(playerID == null)) && (!(entityID == null)) && (!world.isRemote)) {
			ItemStack stack = player.inventory.getCurrentItem();
		      ...
		      if (stack != null && ((stack.getItem() == BlocksRegistry.buildingmallet2) || (stack.getItem() == BlocksRegistry.buildingmallet3)) && entityID.equals(playerID))  // 
		      {
		         return 1F;
