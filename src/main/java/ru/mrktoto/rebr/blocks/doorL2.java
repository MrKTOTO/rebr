...
public class doorL2 extends BlockTileEntity<TileCodeDoor>{
    private IIcon[] field_150017_a;
    private IIcon[] field_150016_b;
    private static final String __OBFID = "CL_00000230";

    public doorL2(String name, Material material, float hardness, float resistanse, SoundType soundType)
        {
    		...
    		this.setBlockTextureName(rebr.MODID + ":" + "forstess_door/forstess_doorL2");
        ...
        {
            return (par2 & 8) != 0 ? null : (BlocksRegistry.doorL2_item);
        }
        ...
        {
            return BlocksRegistry.doorL2_item;
        }
