...
public class doorL1 extends BlockTileEntity<TileCodeDoor>{
    private IIcon[] field_150017_a;
    private IIcon[] field_150016_b;
    private static final String __OBFID = "CL_00000230";

    public doorL1(String name, Material material, float hardness, float resistanse, SoundType soundType)
        {
    		...
    		this.setBlockTextureName(rebr.MODID + ":" + "forstess_door/forstess_doorL1");
        ...
        {
            return (par2 & 8) != 0 ? null : (this.blockMaterial == Material.iron ? Items.iron_door : BlocksRegistry.doorL_item);
        }
        ...
        {
            return this.blockMaterial == Material.iron ? Items.iron_door : BlocksRegistry.doorL_item;
        }
